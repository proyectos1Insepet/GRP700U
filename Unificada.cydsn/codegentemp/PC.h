...
#define PC_TXBUFFERSIZE                   (4u)
#define PC_RXBUFFERSIZE                   (100u)
...
#define PC_BIT_CENTER                         (PC_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 PC_initVar;
    ...
    extern volatile uint8 PC_txBuffer[PC_TXBUFFERSIZE];
    extern volatile uint8 PC_txBufferRead;
    extern uint8 PC_txBufferWrite;
#endif /* End PC_TX_ENABLED */
#if( ( PC_RX_ENABLED || PC_HD_ENABLED ) && \
     (PC_RXBUFFERSIZE > PC_FIFO_LENGTH) )
    extern volatile uint8 PC_rxBuffer[PC_RXBUFFERSIZE];
...
#if (PC_RXHW_ADDRESS_ENABLED)
    #define PC_RXADDRESSMODE      (0u)
    #define PC_RXHWADDRESS1       (0u)
    #define PC_RXHWADDRESS2       (0u)
