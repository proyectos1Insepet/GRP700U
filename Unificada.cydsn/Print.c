...
void imprimir_corte(uint8 val){
    ...
    write_psoc1(val,((lado.a.dir/10)+48));
	write_psoc1(val,((lado.a.dir%10)+48));
    write_psoc1(val,10);  
	get_totales(lado.a.dir,val);
    write_psoc1(val,10); 
	write_psoc1(val,10); 
	for(x=0;x<=10;x++){										//POSICION								
		write_psoc1(val,msn_pos[x]);
	}
    write_psoc1(val,((lado.b.dir/10)+48));
	write_psoc1(val,((lado.b.dir%10)+48));	
	write_psoc1(val,10);
	get_totales(lado.b.dir,val);
	fecha_corte[0]=5;
